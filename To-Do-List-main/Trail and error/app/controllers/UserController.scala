...
class UserController @Inject()(
    ...
    def showtemplatethree = Action { implicit request: MessagesRequest[AnyContent] =>
        Ok(views.html.templatethree()) }

    def showContact = Action { implicit request: MessagesRequest[AnyContent] =>
        Ok(views.html.Contact()) }

    def showTeam = Action { implicit request: MessagesRequest[AnyContent] =>
        Ok(views.html.Team())
    }


    def showtemplatetwo = Action { implicit request: MessagesRequest[AnyContent] =>
        Ok(views.html.templatetwo()) }

    def showTemplate = Action { implicit request: MessagesRequest[AnyContent] =>
        Ok(views.html.template())
    }

    def showabout = Action { implicit request: MessagesRequest[AnyContent] =>
        Ok(views.html.about())
    }
